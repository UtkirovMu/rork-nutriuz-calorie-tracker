...
export default function AchievementsScreen() {
  ...
  const ds = useMemo(() => StyleSheet.create({
    ...
    headerTitle: { fontSize: 48, fontWeight: '800' as const, color: colors.white, letterSpacing: -2 },
    headerSubtitle: { fontSize: 15, color: 'rgba(255,255,255,0.8)', fontWeight: '500' as const, marginTop: 4 },
    progressBarTrack: {
      width: '100%' as const,
      height: 8,
    ...
    progressText: { fontSize: 13, color: 'rgba(255,255,255,0.7)', marginTop: 8, fontWeight: '600' as const },
    categoryTitle: {
      fontSize: 18,
    ...
    badgeTitle: { fontSize: 14, fontWeight: '700' as const, color: colors.text, textAlign: 'center' as const, marginBottom: 4 },
    ...
    badgeUnlockedText: { fontSize: 10, fontWeight: '600' as const, color: colors.primary },
    badgeLockedTag: {
    ...
    badgeLockedText: { fontSize: 10, fontWeight: '600' as const, color: colors.textTertiary },
  }), [colors]);
