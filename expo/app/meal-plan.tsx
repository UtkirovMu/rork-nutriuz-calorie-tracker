...
Har bir kunning jami kaloriyasi ${dailyTargets.calories} kkal atrofida bo'lsin.`;
  ...
  const ds = useMemo(() => StyleSheet.create({
    ...
    emptyTitle: { fontSize: 24, fontFamily: 'Outfit_800ExtraBold', color: colors.text, letterSpacing: -0.5 },
    ...
    generateBtnText: { fontSize: 17, fontFamily: 'Outfit_700Bold', color: colors.white },
    dayScroll: {
      marginBottom: 14,
    ...
    dayChipText: { fontSize: 14, fontFamily: 'Outfit_600SemiBold', color: colors.textSecondary },
    ...
    totalValue: { fontSize: 22, fontFamily: 'Outfit_800ExtraBold', color: colors.white },
    totalLabel: { fontSize: 11, color: 'rgba(255,255,255,0.7)', fontFamily: 'Outfit_500Medium', marginTop: 2 },
    mealCard: {
    ...
    mealLabel: { fontSize: 16, fontFamily: 'Outfit_700Bold', color: colors.text },
    mealName: { fontSize: 17, fontFamily: 'Outfit_600SemiBold', color: colors.text, marginBottom: 4 },
    ...
    macroValue: { fontSize: 15, fontFamily: 'Outfit_700Bold' },
    macroLabel: { fontSize: 10, color: colors.textTertiary, fontFamily: 'Outfit_500Medium', marginTop: 2 },
    regenBtn: {
      flexDirection: 'row' as const,
      alignItems: 'center' as const,
      justifyContent: 'center' as const,
    ...
    regenText: { fontSize: 15, fontFamily: 'Outfit_600SemiBold', color: colors.primary },
  }), [colors]);
