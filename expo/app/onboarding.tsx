...
import { ChevronRight, ChevronLeft, User, Target, Zap, Sparkles, Heart, TrendingUp, TrendingDown, Minus, Ruler, Scale, Clock, Crosshair, ArrowRight } from 'lucide-react-native';
...
export default function OnboardingScreen() {
  ...
  const handleComplete = async () => {
    ...
    console.log('[Onboarding] Profile saved via API for:', auth.identifier);
  ...
  const goalOptions: { value: Goal; label: string; description: string; imageUrl: string; color: string; icon: typeof TrendingDown }[] = [
    { value: 'lose', label: "Vazn yo'qotish", description: 'Kunlik kaloriya defitsiti', imageUrl: 'https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Fire/3D/fire_3d.png', color: colors.protein, icon: TrendingDown },
    { value: 'maintain', label: 'Vaznni saqlash', description: 'Hozirgi vaznda qolish', imageUrl: 'https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Balance%20scale/3D/balance_scale_3d.png', color: colors.primary, icon: Minus },
    { value: 'gain', label: 'Vazn olish', description: 'Kunlik kaloriya surplyusi', imageUrl: 'https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Flexed%20biceps/3D/flexed_biceps_3d_default.png', color: colors.carbs, icon: TrendingUp },
  ];
      ...
      <View style={styles.optionsGroup}>
        {goalOptions.map(opt => {
          ...
          return (
            ...
            >
              <View style={[styles.optionIconCircle, { backgroundColor: opt.color + '18', padding: 8 }]}>
                <Image source={{ uri: opt.imageUrl }} style={{ width: 32, height: 32 }} resizeMode="contain" />
              </View>
  ...
  const activityOptions: { value: ActivityLevel; label: string; description: string; imageUrl: string; level: number }[] = [
    { value: 'sedentary', label: 'Kam harakatli', description: 'Ofis ishi, kam yurish', imageUrl: 'https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Couch%20and%20lamp/3D/couch_and_lamp_3d.png', level: 1 },
    { value: 'moderate', label: "O'rtacha faol", description: 'Haftada 3-5 marta sport', imageUrl: 'https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Person%20walking/3D/person_walking_3d_default.png', level: 2 },
    { value: 'active', label: 'Juda faol', description: 'Har kuni sport, og\'ir ish', imageUrl: 'https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Person%20running/3D/person_running_3d_default.png', level: 3 },
  ];
      ...
      <View style={styles.optionsGroup}>
        {activityOptions.map(opt => {
          ...
          return (
            ...
            >
              <View style={[styles.optionIconCircle, { backgroundColor: colors.primaryLight, padding: 8 }]}>
                <Image source={{ uri: opt.imageUrl }} style={{ width: 32, height: 32 }} resizeMode="contain" />
              </View>
              <View style={styles.optionTextGroup}>
        ...
        >
          <View style={styles.header}>
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              <Text style={ds.progressText}>{currentStep + 1} of {STEPS.length}</Text>
            </View>
            <View style={styles.backPlaceholder} />
          </View>
          ...
          <View style={styles.footer}>
            ...
            >
              {isFinal ? (
                 <Text style={{ fontFamily: 'Outfit_600SemiBold', color: isDark ? '#000000' : '#FFFFFF', fontSize: 16 }}>Go</Text>
              ) : (
                 <ArrowRight size={24} color={isDark ? '#000000' : '#FFFFFF'} />
              )}
            </TouchableOpacity>
          </View>
        </KeyboardAvoidingView>
