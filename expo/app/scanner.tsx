...
const MEAL_OPTION_KEYS: { type: MealType; key: string; emoji: string }[] = [
          ...
          {!imageUri ? (
            ...
            <>
              ...
              {results.length > 0 && currentFood && macroData && (
                <Animated.View style={[staticStyles.resultSection, {
                  opacity: resultFade,
                        ...
                        return (
                          ...
                          >
                            <View style={[ds.mealTypeIconWrap, isActive && ds.mealTypeIconWrapActive]}>
                              <Text style={staticStyles.mealTypeEmoji}>{opt.emoji}</Text>
                            </View>
                  ...
                  >
                    ...
                    <Text style={staticStyles.saveButtonText}>{tr('scanner', 'addToLog')}</Text>
                  </TouchableOpacity>
                </Animated.View>
              )}
            </>
