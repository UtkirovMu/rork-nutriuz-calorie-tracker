...
export default function ProgressPhotosScreen() {
  ...
  const ds = useMemo(() => StyleSheet.create({
    ...
    headerBtnText: { fontSize: 13, fontWeight: '600' as const, color: colors.primary },
    dateLabel: {
      fontSize: 14,
    ...
    photoDate: { fontSize: 11, color: '#FFFFFF', fontWeight: '500' as const },
    deleteBtn: {
      width: 28,
      height: 28,
      borderRadius: 14,
    ...
    countText: { fontSize: 15, fontWeight: '600' as const, color: colors.textSecondary },
    countValue: { fontSize: 18, fontWeight: '800' as const, color: colors.primary },
  }), [colors]);
