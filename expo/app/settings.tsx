...
export default function SettingsScreen() {
  ...
  const ds = useMemo(() => StyleSheet.create({
    ...
    settingLabel: { fontSize: 16, fontFamily: 'Outfit_500Medium', color: colors.text, flex: 1 },
    ...
    dangerText: { fontSize: 16, fontFamily: 'Outfit_500Medium', color: colors.danger, flex: 1 },
    versionText: {
      fontSize: 13,
